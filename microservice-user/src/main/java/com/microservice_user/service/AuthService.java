...
import com.microservice_user.repository.OurUserRepo;
@Service
public class AuthService {
    ...
    public ReqRes signUp(ReqRes registrationRequest){
        ...
        try {
            ...
            UserEntity ourUserResult = ourUserRepo.save(userEntity);
            if (ourUserResult != null && ourUserResult.getId() > 0) {
                resp.setUserEntity(ourUserResult);
    ...
    public ReqRes refreshToken(ReqRes refreshTokenReqiest){
        ...
        UserEntity users = ourUserRepo.findByEmail(ourEmail).orElseThrow();
